...
import { PlusCircle, ThumbsUp, ThumbsDown, Globe } from 'lucide-react';
          ...
          {proposals.map(proposal => (
              <Card key={proposal.id}>
                ...
                <CardContent>
                  ...
                  <p className="text-xl font-semibold text-center">Similarity Score: {proposal.score.toFixed(2)}%</p>
