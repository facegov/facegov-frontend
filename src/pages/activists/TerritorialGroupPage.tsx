...
import { Users, Calendar, MessageSquare, Vote } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        <Card>
          ...
          <CardContent>
            <p>We are the local branch of the XX in Rome. Our mission is to promote citizen participation and address local issues.</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p>Join our online platform to participate in local decision-making processes and propose new initiatives.</p>
            Access Platform
          </CardContent>
        </Card>
      </div>
