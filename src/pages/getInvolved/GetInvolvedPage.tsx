                ...
                <main>
                    <section className="bg-white rounded-lg shadow-md p-6 mb-8">
                        ...
                        <p className="text-lg font-semibold mb-4">
                            The mission? Empowering everyday people to become informed, connected, and influential
                            advocates, while fostering political accountability."
                        </p>
                    </section>

                    <section className="bg-blue-100 rounded-lg p-6 mb-8">
                        <h2 className="text-2xl font-bold mb-4 text-blue-800">Here's how FaceGov can help change the
                            game:</h2>
                        <ul className="list-disc pl-6 space-y-2">
                            ...
                            <li><span className="font-semibold">Power Tracker:</span> Keep tabs on your
                                representatives'
                                every move and vote.
                            </li>
                    ...
                    <section className="text-center bg-yellow-100 rounded-lg p-6 mb-8">
                        <p className="text-xl mb-4">
                            Democracy is a team sport, and FaceGov is building a global league of political
                            superstars.
                            Whether you're a seasoned activist or a newcomer ready to make waves, there's a place
                            for
